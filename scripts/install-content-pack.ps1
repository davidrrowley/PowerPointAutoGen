# Install content pack (standards, specs, agents) into an existing scaffold repo.
# Compatible with Windows PowerShell 5.1 and PowerShell 7+
#
# Usage (from repo root, after unzipping this pack into the repo root):
#   powershell -ExecutionPolicy Bypass -File .\scripts\install-content-pack.ps1
#
# Options:
#   -Source .\origin
