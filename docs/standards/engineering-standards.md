...
## Agent routing and cost
- Prefer the cheapest adequate model/provider for each task.
- Escalate to higher-cost models only when complexity or risk justifies it.
- Orchestrator is coordination-first and delegates work to specialists.
